    ...
    <DashboardLayout>
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Click on any employee to view monthly attendance</p>
        </div>
        <input
          type="date"
          value={selectedDate}
          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="text-left text-xs font-medium text-gray-500 px-4 py-3">Override</th>
              </tr>
            </thead>
            <tbody>
              {employees.map((emp) => {
                    ...
                    <td className="px-4 py-3" onClick={(e) => e.stopPropagation()}>
                      {att ? (
                        <select
                          ...
                          onChange={async (e) => {
                            try {
                              await API.put(`/hr/attendance/${att.id}/status`, {
                          ...
                          className="text-xs px-2 py-1.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                        >
